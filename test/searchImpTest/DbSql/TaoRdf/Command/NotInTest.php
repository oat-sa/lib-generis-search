...
use oat\search\DbSql\TaoRdf\Command\NotIn;
 ...
 */
class NotInTest extends UnitTestHelper
{
    public function setUp(): void
    {
        $this->instance = new NotIn();
    ...
    public function convertProvider(): \Generator
    {
        yield [
            ...
            [0 , 5 , 10],
            '`predicate` = "http://www.w3.org/2000/01/rdf-schema#label" AND ( `object` NOT IN ("0" , "5" , "10") '
        ];

        yield [
            'http://www.w3.org/2000/01/rdf-schema#label',
            'test',
            '`predicate` = "http://www.w3.org/2000/01/rdf-schema#label" AND ( `object` NOT IN ("test") '
        ];
