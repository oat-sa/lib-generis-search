...
use oat\search\DbSql\TaoRdf\QuerySerialyser;
 ...
 */
class QuerySerialyserTest extends UnitTestHelper
{

    public function setUp(): void
    {
        $this->instance = new QuerySerialyser();
    }
    ...
    public function testFinishQuery()
    {
        ...
        $this->instance = $this->getMockBuilder('oat\search\DbSql\TaoRdf\QuerySerialyser')
            ->setMethods(
